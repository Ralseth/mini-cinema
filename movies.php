...
<div class="wrapper">
    ...
    <main class="main">
        <h1 class="movies-title">Фильмы для вас</h1>
        <div class="cards">
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card1.png" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card2.png" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card3.jpg" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card4.jpg" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card5.jpeg" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card6.jpg" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card7.webp" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card8.jpeg" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card9.jpg" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card10.jpg" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card11.jpg" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card12.png" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card13.png" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card14.png" alt="Фильм">
                </a>
            </div>
            <div class="card">
                <a href="watching.php">
                    <img src="styles/img/card15.jpg" alt="Фильм">
                </a>
            </div>
        </div>
        <div class="auth-form">
